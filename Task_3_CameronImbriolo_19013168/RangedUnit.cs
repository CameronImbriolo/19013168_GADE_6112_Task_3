...
namespace Task_1_CameronImbriolo_19013168
{
    ...
    {
        private int Ranged_Damage = 5;
        private int Ranged_Speed = 2;
        ...
        public RangedUnit(string name, int health, Faction unitFaction, int attackRange, int xPos, int yPos)
        {
            Name = name;
            Health = health;
        ...
        public RangedUnit(string name, int health, Faction unitFaction, int attackRange)
        {
            Name = name;
            Health = health;
            UnitFaction = unitFaction;
